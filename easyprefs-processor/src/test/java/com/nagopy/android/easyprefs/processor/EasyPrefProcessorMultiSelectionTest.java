...
public class EasyPrefProcessorMultiSelectionTest {

    final TestHelper testHelper = new TestHelper(
            "MultiSelectionSample",
            "/multiselection/",
            "GenMultiSelectionSample",
            "MultiSelectionSample_MultiSelectionPreference");

    @Test
    public void リソース指定あり() throws Throwable {
        testHelper.testProvider("リソース指定あり");
        testHelper.testPreference("リソース指定あり");
    }

    @Test
    public void リソース指定なし() throws Throwable {
    ...
    public void コンパイル時チェック_Interface未実装() throws Throwable {
        ...
        assert_().about(javaSource())
                ...
                .processedWith(new EasyPrefProcessor())
                .failsToCompile()
                .withErrorContaining("must implements MultiSelectionItem");
    }
